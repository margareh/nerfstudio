...
from nerfstudio.models.depth_nerfacto_lunarlab import DepthNerfactoLLModelConfig
from nerfstudio.models.generfacto import GenerfactoModelConfig
from nerfstudio.models.instant_ngp import InstantNGPModelConfig
from nerfstudio.models.mipnerf import MipNerfModel
from nerfstudio.models.nerfacto import NerfactoModelConfig
from nerfstudio.models.nerfacto_lunarlab import NerfactoLLModelConfig
...
descriptions = {
    ...
    "nerfacto-lunarlab": "Nerfacto but with additional output values and configured for lunar lab data.",
    "depth-nerfacto": "Nerfacto with depth supervision.",
    "depth-nerfacto-ll" : "Nerfacto with depth supervision and additional output values, configured for lunar lab data.",
...
method_configs["nerfacto-lunarlab"] = TrainerConfig(
    method_name="nerfacto-lunarlab",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
    pipeline=VanillaPipelineConfig(
        datamanager=VanillaDataManagerConfig(
            dataparser=LunarLabDataParserConfig(),
            train_num_rays_per_batch=4096,
            eval_num_rays_per_batch=4096,
            camera_optimizer=CameraOptimizerConfig(
                mode="SO3xR3",
        ...
        model=NerfactoLLModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
...
method_configs["depth-nerfacto-ll"] = TrainerConfig(
    method_name="depth-nerfacto-ll",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
    pipeline=VanillaPipelineConfig(
        ...
        model=DepthNerfactoLLModelConfig(eval_num_rays_per_chunk=1 << 15),
    ),
    optimizers={
        "proposal_networks": {
            "optimizer": AdamOptimizerConfig(lr=1e-2, eps=1e-15),
...
method_configs["visibility-nerfacto-ll"] = TrainerConfig(
    method_name="visibility-nerfacto-ll",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
...
method_configs["vis_depth_ll"] = TrainerConfig(
    method_name="vis-depth-ll",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
