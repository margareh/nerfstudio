...
from nerfstudio.models.nerfacto_lunarlab import NerfactoLLModel, NerfactoLLModelConfig
from nerfstudio.utils import colormaps


@dataclass
class DepthNerfactoLLModelConfig(NerfactoLLModelConfig):
    """Additional parameters for depth supervision."""

    _target: Type = field(default_factory=lambda: DepthNerfactoLLModel)
...
class DepthNerfactoLLModel(NerfactoLLModel):
    ...
    config: DepthNerfactoLLModelConfig
